    ...
    public class IpfsBridge : MonoBehaviour {
        ...
        public static async Task<T> GetIpfsFile<T>(string hash, bool thumbnail = false) where T : Object {
            ...
            switch(www.GetResponseHeader("Content-Type")) {
                ...
                case "image/webp":
                return await LoadWebP(www.downloadHandler.data, hash) as T;
                case "video/mp4":
        ...
        private static async Task<Object> LoadWebP(byte[] bytes, string hash) {
            try {
                ...
                Debug.Log(e);
                return await GetIpfsFile<Object>(hash);
